...
// Routes for various project pages
...
router.get('/projects/bees', (req, res) => {
    res.sendFile(__dirname + '/project/bees.html');
});

router.get('/projects/frontlines', (req, res) => {
...
router.get('/projects/micro', (req, res) => {
    res.sendFile(__dirname + '/project/micro.html');
});

router.get('/projects/ppp', (req, res) => {
...
router.get('/projects/uftp', (req, res) => {
